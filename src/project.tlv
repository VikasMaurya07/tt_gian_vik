...
\TLV calc()
   ...
   |calc
      @1
         ...
         $out[7:0] = $reset ? 0 : ~$valid ? >>1$out : $op[1] ? ($op[0] ? $div[7:0]  : $mul[7:0]) : ($op[0] ? $sub[7:0]  : $sum[7:0]);
         
         /*$digits[3:0] = $out[3:0];
         *uo_out = ($digits == 4'h0) ? 8'b00111111 :  // 0
                   ($digits == 4'h1) ? 8'b00000110 :  // 1
                   ($digits == 4'h2) ? 8'b01011011 :  // 2
                   ($digits == 4'h3) ? 8'b01001111 :  // 3
                   ($digits == 4'h4) ? 8'b01100110 :  // 4
                   ($digits == 4'h5) ? 8'b01101101 :  // 5
                   ($digits == 4'h6) ? 8'b01111101 :  // 6
                   ($digits == 4'h7) ? 8'b00000111 :  // 7
                   ($digits == 4'h8) ? 8'b01111111 :  // 8
                   ($digits == 4'h9) ? 8'b01101111 :  // 9
                   ($digits == 4'hA) ? 8'b01110111 :  // A
                   ($digits == 4'hB) ? 8'b01111100 :  // B
                   ($digits == 4'hC) ? 8'b00111001 :  // C
                   ($digits == 4'hD) ? 8'b01011110 :  // D
                   ($digits == 4'hE) ? 8'b01111001 :  // E
                   ($digits == 4'hF) ? 8'b01110001 :  // F
                                   8'b00000000;    // Default*/
